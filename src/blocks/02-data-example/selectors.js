...
export const coreBlocks = () => {
  ...
  // console.log(
  //   "getBlockSupport",
  //   select("core/blocks").getBlockSupport("adv-gut-zac/gallery", "align")
  // );
  ...
  // console.log(
  //   "hasBlockSupport",
  //   select("core/blocks").hasBlockSupport("adv-gut-zac/gallery", "align")
  // );
  // console.log(
  //   "hasChildBlocks",
...
export const coreEditPost = () => {
  ...
  console.log(
    "isPluginItemPinned",
    select("core/edit-post").isPluginItemPinned("adv-gut-zac/toc")
  );
  // isPluginSidebarOpened:
  console.log(
    "isPluginSidebarOpened",
    select("core/edit-post").isPluginSidebarOpened("adv-gut-zac/toc")
  );
